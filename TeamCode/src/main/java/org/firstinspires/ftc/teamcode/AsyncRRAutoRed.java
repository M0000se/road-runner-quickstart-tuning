...
public class AsyncRRAutoRed extends LinearOpMode {
    ...
    enum State {
        UP_TO,   // First, follow a splineTo() trajectory
        TO_CONE,   // Then, follow a lineTo() trajectory
        TO_POLE,         // Then we want to do a point turn
        TO_CONE_CYCLE,   // Then, we follow another lineTo() trajectory
        TO_POLE_CYCLE,         // Then we're gonna wait a second
        TO_TERMINAL,         // Finally, we're gonna turn again
